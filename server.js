...
const io = new Server(server, {
    cors: {
        origin: ["https://badsparky.github.io"], // This allows all origins. For production, specify your client app's URL.
        // origin: ["https://badsparky.github.io", "http://localhost:3001"], // This allows all origins. For production, specify your client app's URL.
